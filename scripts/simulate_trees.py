...
def simulateTree(
    ...
    outname = os.path.join(outdir, str(i) + "_" + str(numtips) + "_tips.newick")
...
if __name__ == "__main__":
    ...
    .newick tree files will be saved",
    )
    ...
    hodiams = read_list(os.path.join(ROOT, "data", "hogenom_diams.txt"))
    raxdiams = read_list(os.path.join(ROOT, "data", "raxml_diams.txt")) * 10
